/* Check that the triggers from task C. work - for this purpose simulate an order and a price update */

/* Check behaviour of the first trigger from task C. - Simulation of a customer placing an order */
...
/* The items specified above are added to this order with the quantities defined above */
...
/* Check behaviour of the first trigger from task C. - The unit price of 'Nike_34' is changed */
